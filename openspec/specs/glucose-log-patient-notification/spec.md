# Capability: Glucose Log Patient Notification

## Purpose

Notifica en tiempo real al paciente correspondiente cuando se registra exitosamente una nueva lectura de glucosa, destacando en el contenido cuando la lectura está fuera de rango.
