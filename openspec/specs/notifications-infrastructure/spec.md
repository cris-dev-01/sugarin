# Capability: Notifications Infrastructure

## Purpose

Provee la infraestructura central del sistema de notificaciones: la tabla `notifications`, el tipo de negocio `App\Enums\NotificationType`, el despacho en cola, los endpoints de listado y marcado como leídas, la prop compartida de Inertia con las notificaciones no leídas, y el componente de notificaciones in-app en el header (dropdown y drawer de historial).
