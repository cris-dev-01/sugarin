...
Provides a quick way to locate a patient by name or RUT from the application header, landing the user on the dashboard with that patient's summary already loaded.
