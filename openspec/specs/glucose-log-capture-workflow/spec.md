# Capability: Glucose Log Capture Workflow

## Purpose

Provides a guided, mobile-friendly flow for administrators to register a patient's glucose reading by photographing their glucose meter, extracting the value via OCR, confirming it, and viewing a success summary that visually highlights abnormal readings.
