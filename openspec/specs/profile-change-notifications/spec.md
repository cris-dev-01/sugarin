# Capability: Profile Change Notifications

## Purpose

Notifica al usuario, por el canal `database`, cuando actualiza exitosamente sus datos básicos de perfil o su contraseña.
