# Capability: Glucose Log History

## Purpose

Provides a paginated, date-filterable history endpoint of a patient's glucose logs, restricted so non-Administrator users can only view their own records.
